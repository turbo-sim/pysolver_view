...
grad_forward_fd_scalar = pv.approx_gradient(f, x0, abs_step=h, method="forward_finite_differences")
...
grad_central_fd_scalar = pv.approx_gradient(f, x0, abs_step=h, method="central_finite_differences")
...
grad_complex_step_scalar = pv.approx_gradient(f, x0, abs_step=h, method="complex_step")
